              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    icon: "fa-envelope",
                    title: "Email Support",
                    content: ["Response within 24hrs", "info@valtierfingroup.com"],
                    color: "purple",
                  },
                  ...
                  <div key={idx} className="flex items-start space-x-4 p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 rounded-2xl hover:shadow-lg transition-all duration-300">
                    <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center ${contact.color === 'primary' ? 'bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/50 dark:to-primary-800/50' :
                      ...
                      <i className={`fa-solid ${contact.icon} text-lg ${contact.color === 'primary' ? 'text-primary-600 dark:text-primary-400' :
                ...
                <div className="flex space-x-4">
                  {[
                    ...
                    <a
                      key={idx}
                      href={social.href}
                      className={`w-12 h-12 rounded-xl flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg ${social.color === 'blue' ? 'bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700' :
