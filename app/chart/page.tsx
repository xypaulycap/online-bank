          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                At Valtier Financial Group, we understand that personal banking needs vary from person to person. That's why we offer a range of services and products tailored to help you achieve your individual financial goals.
              </p>
